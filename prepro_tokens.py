...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='caption_train_chinese.json', help='input json file to process into hdf5')
  parser.add_argument('--info_json', default='info_train_chinese.json', help='info json file')
